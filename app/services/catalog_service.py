...
def create_catalog_item_from_form(form) -> tuple[str, int]:
    ...
    if kind == "raw":
        ...
        log_activity("create_raw_material", "raw_material", item_id, str(form["name"]).strip())
        audit_event("create_raw_material", "raw_material", item_id, after=created)
    ...
    log_activity("create_product", "finished_product", item_id, str(form["name"]).strip())
    audit_event("create_product", "finished_product", item_id, after=created)
    backup_database("create_product")
...
def update_raw_material_from_form(material_id: int, form) -> None:
    ...
    log_activity("update_price", "raw_material", material_id, f"{form['name'].strip()} | achat={avg_cost} | vente={sale_price}")
    audit_event("update_raw_material", "raw_material", material_id, before=before, after=updated)
...
def update_product_from_form(product_id: int, form) -> None:
    ...
    log_activity("update_price", "finished_product", product_id, f"{form['name'].strip()} | revient={avg_cost} | vente={sale_price}")
    audit_event("update_product", "finished_product", product_id, before=before, after=updated)
...
def delete_raw_material_by_id(material_id: int) -> bool:
    ...
    audit_event("delete_raw_material", "raw_material", material_id, before=before, after=None)
...
def delete_product_by_id(product_id: int) -> bool:
    ...
    audit_event("delete_product", "finished_product", product_id, before=before, after=None)
